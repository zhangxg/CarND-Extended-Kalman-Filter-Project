...
int main() {
  ...
  //    FileLoader fileLoader =
  //    FileLoader("../data/sample-laser-radar-measurement-data-1.txt");
  //    FileLoader fileLoader =
  //    FileLoader("../data/sample-laser-radar-measurement-data-2.txt");
  ...
  for (size_t k = 0; k < N; ++k) { // start filtering from the second frame (the
                                   // speed is unknown in the first frame)
    cout << k << "====" << endl;
